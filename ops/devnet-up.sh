...
# time in this script.
#
# This script is save to run multiple times. It stores state in `.devnet`, and
...
if [ ! -f ./packages/contracts/deployments/devnetL1/genesis-l1.json ]; then
...
docker-compose run -e L2OO_ADDRESS="$L2OO_ADDRESS" -d l2os
cd ../
